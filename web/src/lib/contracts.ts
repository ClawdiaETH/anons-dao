...
// Aliases for BidForm component
export const ANONS_AUCTION_HOUSE = AUCTION_HOUSE_ADDRESS
export const ANONS_TOKEN = TOKEN_ADDRESS
export const ERC8004_REGISTRY = ERC8004_REGISTRY_ADDRESS
...
// Alias for BidForm component
export const AUCTION_HOUSE_ABI = auctionHouseABI
