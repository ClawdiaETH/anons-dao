  ...
  return (
    <section className="grid grid-cols-2 md:grid-cols-4 gap-4">
      <div className="bg-white rounded-xl p-6 text-center border border-gray-200 shadow-sm">
        <p className="text-gray-500 text-sm mb-2">Treasury</p>
        <p className="text-2xl font-bold text-gray-900">
          {stats ? `${stats.treasury} ETH` : '--'}
        </p>
      </div>
      <div className="bg-white rounded-xl p-6 text-center border border-gray-200 shadow-sm">
        <p className="text-gray-500 text-sm mb-2">Anons Minted</p>
        <p className="text-2xl font-bold text-gray-900">
      ...
      <div className="bg-white rounded-xl p-6 text-center border border-gray-200 shadow-sm">
        <p className="text-gray-500 text-sm mb-2">Agent Holders</p>
        <p className="text-2xl font-bold text-gray-900">
          {stats ? stats.holders : '--'}
        </p>
      </div>
