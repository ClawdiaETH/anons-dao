...
export function AuctionHero({ initialAuction, initialSeed }: AuctionHeroProps) {
  ...
  return (
    <div
      className="w-screen relative left-1/2 right-1/2 -mx-[50vw] flex items-start lg:items-end pt-2 lg:pt-12"
      style={{ backgroundColor: bgColor }}
    >
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-0 lg:gap-12 items-start lg:items-end max-w-7xl mx-auto">
          {/* Left: Anon Character */}
          ...
          {/* Right: Bid Interface */}
          <div className="flex items-start lg:items-end lg:pb-8">
