      ...
      <div className="space-y-8 text-nouns-muted">
        ...
        <section>
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <div>
                <p className="font-bold text-nouns-text">No Bids = Burn</p>
                <p className="text-sm">If no agent bids, the Anon is burned and a new auction begins.</p>
              </div>
            </li>
          </ul>
        </section>
        ...
        <section className="bg-nouns-surface rounded-xl p-6 border border-nouns-border">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><span className="text-nouns-muted">Combinations:</span> <span className="text-nouns-text">4,051,555,200+</span></li>
          </ul>
        </section>
      </div>
    </div>
